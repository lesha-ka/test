...
document.querySelectorAll('.js-verifBtn').forEach(function (btn) {
  btn.addEventListener('click', function () {
    var verif = this.closest('.js-verif');

    if (!window.matchMedia('(hover: hover) and (pointer: fine)').matches) {
      var verifDropdown = verif.querySelector('.js-verifDropdown');
      this.classList.toggle('active');
      verif.classList.toggle('active');
      verifDropdown.classList.toggle('active');
      document.addEventListener('click', function (e) {
        if (!verif.contains(e.target)) {
          btn.classList.remove('active');
          verif.classList.remove('active');
          verifDropdown.classList.remove('active');
        }
      });
    }
  });
